// Modified example inspired from https://en.cppreference.com/w/cpp/feature_test
// See also https://github.com/makelinux/examples/blob/develop/cpp/features.cpp
//#region [Collapse all]
...
int main() {
  if (print.general_features)
    show("C++ GENERAL", cxx);
  if (print.cxx11 && print.core_features)
    show("C++11 CORE", cxx11);
  if (print.cxx14 && print.core_features)
    show("C++14 CORE", cxx14);
  if (print.cxx14 && print.lib_features)
